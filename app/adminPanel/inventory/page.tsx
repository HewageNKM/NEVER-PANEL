...
const Page = () => {
    return (
        <div className="mt-16 px-4 py-4 flex flex-col">
            ...
            <div className="mt-2 flex justify-between flex-wrap gap-5 flex-row">
                <div className="flex flex-col gap-1">
                    <label className="flex relative flex-col gap-1">
                        ...
                        <input type="text" placeholder="Search" className="p-1 pr-8 border-2 border-slate-300 rounded w-full md:w-[15rem]"/>
                        <button className="absolute top-10 right-2 "><IoSearch size={20}/></button>
                    </label>
                    <label className="flex flex-col mt-2">
                        <span className="font-bold text-lg">Brands</span>
                        <select defaultValue="all" className="w-full md:w-[15rem] p-1 border-2 text-black rounded font-medium">
                ...
                <div className="flex justify-center items-center">
                    <button className="bg-black text-white flex flex-row justify-center items-center h-[2.8rem] px-3 py-1 rounded hover:bg-gray-800">
                        <IoAdd size={30}/>
                        Add Item
                    </button>
                </div>
                ...
                <table className="min-w-full table-auto text-left">
                    ...
                    <tr className="odd:bg-slate-200 hover:bg-white even:bg-slate-300">
                        ...
                        <td className="p-1 font-medium flex gap-2">
                            <button className="bg-yellow-300 text-white px-3 py-1 rounded hover:bg-yellow-400"><IoPencil size={20}/></button>
                            <button className="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600"><IoTrash size={20}/></button>
                        </td>
                    </tr>
                    </tbody>
                </table>
